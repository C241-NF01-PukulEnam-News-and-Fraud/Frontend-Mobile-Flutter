...
class _CardViewState extends State<CardView> with TickerProviderStateMixin {
      ...
      children: <Widget>[
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              SizedBox(width: 16),
              _buildCategoryButton('All', _isSelected('All')),
              SizedBox(width: 16),
              _buildCategoryButton('Finance', _isSelected('Finance')),
              SizedBox(width: 16),
              _buildCategoryButton('Sports', _isSelected('Sports')),
              SizedBox(width: 16),
              _buildCategoryButton('Politics', _isSelected('Politics')),
              SizedBox(width: 16),
            ],
          ),
        ),
  ...
  Widget _buildCategoryButton(String category, bool isSelected) { // Tambahkan parameter isSelected
